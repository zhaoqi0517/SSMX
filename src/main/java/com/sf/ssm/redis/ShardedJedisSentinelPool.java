 ...
 * <p>
 * 并且是把单master改成多master，同时把Jedis改成ShardedJedis。
 * 支持多主机集群
 *
 * @author 872677
 */
public class ShardedJedisSentinelPool extends Pool<ShardedJedis> {
    ...
    private final static org.slf4j.Logger logger = LoggerFactory.getLogger(ShardedJedisSentinelPool.class);
    ...
    public ShardedJedisSentinelPool(Set<String> masters, Set<String> sentinels, String password) {
        this(masters, sentinels, new GenericObjectPoolConfig(),
                Protocol.DEFAULT_TIMEOUT, password);
    }

    public ShardedJedisSentinelPool(final GenericObjectPoolConfig poolConfig, Set<String> masters, Set<String> sentinels) {
